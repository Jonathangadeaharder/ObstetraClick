...
export const questions: {
  ...
  pfeilnaht: [
      ...
      options: [
        {
          id: "vHHL",
          label: "vHHL / anterior",
          sub: "Occipucio anterior, mecánica favorable",
        },
        {
          id: "hHHL",
          label: "hHHL / posterior",
          sub: "Occipucio posterior, “mira estrellas”",
        },
        {
          id: "asynk",
          label: "Asinclitismo",
          sub: "Sutura desplazada hacia sacro o sínfisis",
        },
      ],
      rationale:
    ...
    },
    {
      ...
      position: "hHHL",
      prompt:
        "La fontanela menor está orientada hacia el sacro. ¿Cómo nombrás el hallazgo?",
      correctId: "hHHL",
      options: [
        {
          id: "vHHL",
          label: "vHHL",
          sub: "El occipucio apunta hacia adelante",
        },
        {
          id: "hHHL",
          label: "hHHL / mira estrellas",
          sub: "El occipucio apunta hacia atrás",
        },
        {
          id: "asynk",
          label: "Asinclitismo",
          sub: "Desviación lateral del eje",
        },
      ],
      rationale:
    ...
    },
    {
      ...
      position: "asynk",
      prompt:
        "La sutura sagital está claramente desplazada hacia el sacro. ¿Cuál es el diagnóstico?",
      correctId: "asynk",
      options: [
        {
          id: "vHHL",
          label: "vHHL",
          sub: "Sutura centrada con orientación anterior",
        },
        {
          id: "synk",
          label: "Sinclitismo",
          sub: "Sutura sagital en el centro de la pelvis",
        },
        {
          id: "asynk",
          label: "Asinclitismo",
          sub: "Un parietal desciende como punto guía",
        },
      ],
      rationale:
  ...
  ctg: [
    {
      ...
      options: [
        ...
        {
          id: "variable",
          label: "Desaceleración variable",
          sub: "Cambian la forma y el timing",
        },
      ],
      rationale:
