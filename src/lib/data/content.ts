...
export const intros: Record<string, Intro> = {
	hotspot: {
		titlePre: 'Localizá',
		title: 'sin dudar',
		intro: 'Tocá láminas anatómicas sin rótulos. La zona objetivo tiene tolerancia para dedo, pero sigue siendo clínicamente preciso.',
		bullets: [
...
export const allLearningItems: LearningItemWithArea[] = learningSections.flatMap((section) =>
...
export const studyGuides: Record<string, StudyGuide> = {
	pfeilnaht: {
		...
		intro: 'Antes de diagnosticar la posición, separá tres referencias: pubis materno, sacro y fontanela menor. Recién después le ponés nombre a la variedad.',
		steps: [
	...
	hotspot: {
		...
		intro: 'Los planos de Hodge no son líneas decorativas: sirven para ubicar descenso fetal y traducir tacto vaginal a una posición clínica.',
		steps: [
